...
- 🌍 **Amplia cobertura** — 250+ GPUs, 400+ modelos principales (Dense 311 + MoE 89)
...
| Categoría | Detalles |
| --- | --- |
| **Modelos** | 400+ modelos principales (Dense 311 + MoE 89) · 0.5B - 2.8T parámetros · Publicados 2022-2026 |
...
│   ├── models/      # Parámetros de modelos (400+)
...
- **Cobertura de modelos** — 400+ modelos open source principales (2022-2026), de 0.5B a 2.8T parámetros
