  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        description: '估算 Qwen3.8-Max（已开源）/ GLM-5.3 / Muse Glimmer / GLM-5.3-Flash / Qwen3.8-Flash-Next / Hy3 / DeepSeek V4 / Kimi K3 等在 RTX 5090、H200、B200 上的 TPS 与显存 / Estimate TPS & VRAM. 410 models, 251 GPUs (2026-09).',
        lang: 'zh-CN',
        theme_color: '#ffffff',
