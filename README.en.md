...
- 🌍 **Wide Coverage** — 250+ GPU models, 400+ mainstream models (Dense 312 + MoE 92)
...
| Category | Details |
| --- | --- |
| **Models** | 400+ mainstream models (Dense 312 + MoE 92) · 0.5B - 2.8T parameters · 2022-2026 releases |
...
│   ├── models/      # Model parameters (400+ models)
...
- **Model Coverage** — 400+ models spanning 2022-2026 mainstream open-source models, parameter scales from 0.5B to 2.8T
