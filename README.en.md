...
- 🌍 **Wide Coverage** — 250+ GPU models, 382+ mainstream models (Dense 298 + MoE 84)
...
| Category | Details |
| --- | --- |
| **Models** | 382+ mainstream models (Dense 298 + MoE 84) · 0.5B - 2.8T parameters · 2022-2026 releases |
...
│   ├── models/      # Model parameters (382+ models)
...
- **Model Coverage** — 382+ models spanning 2022-2026 mainstream open-source models, parameter scales from 0.5B to 2.8T
