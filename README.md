...
- 🌍 **广泛覆盖** — 250+ GPU 型号，403+ 主流模型（Dense 312 + MoE 91）
...
| 类别 | 详细信息 |
| --- | --- |
| **模型** | 403+ 主流模型（Dense 312 + MoE 91）· 0.5B - 2.8T 参数 · 2022-2026 年发布 |
...
- **GPU 规格** — 各厂商官方技术文档
- **模型覆盖** — 403+ 模型，涵盖 2022-2026 年主流开源模型，参数规模从 0.5B 到 2.8T
