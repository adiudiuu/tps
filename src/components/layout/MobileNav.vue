  ...
  <nav class="sm:hidden fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-gray-200">
    <div class="grid grid-cols-3 h-16">
      <RouterLink
        ...
        :class="isActive('/') && route.path === '/' ? 'text-emerald-600' : 'text-gray-500'"
      >
      ...
      <RouterLink
        to="/ranking"
        class="flex flex-col items-center justify-center gap-1 transition-colors"
        :class="isActive('/ranking') ? 'text-emerald-600' : 'text-gray-500'"
      >
        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <RouterLink
        to="/supported"
        class="flex flex-col items-center justify-center gap-1 transition-colors"
        :class="isActive('/supported') ? 'text-emerald-600' : 'text-gray-500'"
      >
        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
